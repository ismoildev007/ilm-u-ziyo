...
<header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
        ...
        <div class="dropdown">
            <button class="btn btn-outline dropdown-toggle mx-1" style="border-radius: 50px" type="button" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false">
